...
<div class="banner-area center">
    ...
    <div class="title_container">
     ...
     <h3 style="text-align: justify;">Once your account is created and registered, your wallet will be credited with a start up bonus interest&nbsp; of 0.0004btc from {{ $site_name }}</h3>
     ...
     <h3 style="text-align: justify;">The 25% give back, is a compensation fee for the work that the Bitcoin miners do to help you multiply your income. Is a way of saying thank you for the good work done every week.</h3> </div><a href="#" id="back-to-top" class="back-to-top fa fa-arrow-up show-back-to-top"></a>
