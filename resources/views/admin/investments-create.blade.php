@include('includes.admin.header')
    ...
    <div class="container vh">
        ...
        <h2 class="mt-4 mb-3 page-title">Create New Investment Plan</h2>
        ...
        <form action="{{url('/admin/investments')}}" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="type">Commission Interval ( <small class="text-muted">Days between each commission</small> )</label>
