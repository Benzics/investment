            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="commission" id="commission" required value="{{ old('commission', $investment->commission) }}" class="form-control" placeholder="Commission">
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="minimum" id="minimum" required value="{{ old('minimum', $investment->minimum) }}" class="form-control" placeholder="Minimum investment amount">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="maximum">Maximum Amount <span class="text-danger">*</span></label>
                        <input type="text" name="maximum" id="maximum" required value="{{ old('maximum', $investment->maximum) }}" class="form-control" placeholder="Maximum investment amount">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="type" id="type" required value="{{ old('type', $investment->type) }}" class="form-control" placeholder="Commission interval">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="times" id="times" required value="{{ old('times', $investment->times) }}" class="form-control" placeholder="Commission times">
                    </div>
                </div>
