...
<div class="banner-area center">
    <div class="area">
        <div class="bodycontainer2">
            <h1 class="tlt text-white" style="margin: 20px 0;">Frequently <span class="text-default">asked questions.</span></h1>
    ...
    6. You can now go and fund your wallet with the required amount of Bitcoin plan that you must have chosen.</p>
            ...
            <div class="accordion-section">
                <a class="accordion-section-title" href="#accordion-5">HOW LONG DOES IT TAKE FOR A BITCOIN WITHDRAWAL TO GET PROCESSED AND FULLY COMFIRMED</a>
                <div id="accordion-5" class="accordion-section-content padding">
                    <p>Maximum of 3HRS</p>
                </div>
            </div>
            </div></div>
